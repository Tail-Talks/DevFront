...
export default function RoadmapCard({ quarter, tasks }: RoadmapCardProps) {
  return (
    <div className='flex flex-col justify-center items-center mr-[90px]'>
      <p className='font-sans font-semibold text-[20px] dark:text-white text-center mt-[25px] sm:mt-[33px]'>
        {quarter}
      </p>
      <div className='w-[300px] sm:w-[346px] border-[3px] dark:border-white border-[#000000] rounded-2xl mt-[20px] sm:mt-[40px] dark:text-white flex flex-col justify-center items-center'>
        <div className='mr-10 ml-10 mb-5 sm:mb-10'>
